...
def genere_strat(carre, move, nb):
    st='board.getMarbleCount(self.player) + center_moi + '+str(carre)+'*carresuivant_pour_moi + '+str(move)+'*move_moi_utile + '+str(nb)+'*nbcarretotal - board.getMarbleCount(-self.player) - center_adv - '+str(carre)+'*carresuivant_pour_adv - '+str(move)+'*move_adv_utile'
    return str(st)
...
f = open("carresuiv_vs_s0_prof4_force.pkl","wb")
...
g = open("carresuiv_vs_s0_prof4_force.txt","w")
